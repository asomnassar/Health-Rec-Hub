...
const EditMedicalRecordModal = () => {
  const { openEditMedicalRecordModal, handleCloseEditMedicalRecordModal } =
    useContext(FormsContext);
  return (
    <Modal
      open={openEditMedicalRecordModal}
      onClose={handleCloseEditMedicalRecordModal}
    >
      <Box
