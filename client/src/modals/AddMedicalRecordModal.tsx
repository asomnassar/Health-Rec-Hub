...
const AddMedicalRecordModal = () => {
  const { openAddMedicalRecordModal, handleCloseAddMedicalRecordModal } =
    useContext(FormsContext);
  return (
    <Modal
      open={openAddMedicalRecordModal}
      onClose={handleCloseAddMedicalRecordModal}
    >
      <Box
