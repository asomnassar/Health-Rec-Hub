    ...
    if (type === "systemManager") {
      setNavs(
        <>
          ...
          <NavLink
            title={"اضافة مريض"}
            link={`${import.meta.env.VITE_ADD_PATIENT_ROUTE}`}
          />
        </>
      );
      ...
      setNavs(
        <>
          ...
          <NavLink
            ...
            link={`${import.meta.env.VITE_PENDING_PATIENTS_ROUTE}`}
          />
          <NavLink
            title={"المرضى المحظورين"}
            link={`${import.meta.env.VITE_BLOCKED_PATIENTS_ROUTE}`}
          />
        </>
      );
    } else if (type === "doctor") {
