...
const Forms = ({type}:FormsTypes) => {
  ...
  const chosenForm=(
    type === "editPatient" ? <EditPatientForm register={register} errors={errors} /> :
    type === "editProfile" ? <EditProfileForm register={register} errors={errors} />  :  type === "changePassword" ? <ChangePasswordForm register={register} errors={errors}/> : 
